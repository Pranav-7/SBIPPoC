...
enum
{
    ...
    attestation_fcn_id_set_host_public_key = 2,
    attestation_fcn_id_process_encrypted_defi = 3,
    attestation_fcn_id_oe_verify_report_ecall = 4,
    attestation_fcn_id_oe_get_sgx_report_ecall = 5,
    attestation_fcn_id_oe_get_report_v2_ecall = 6,
    attestation_fcn_id_oe_verify_local_report_ecall = 7,
    attestation_fcn_id_oe_sgx_init_context_switchless_ecall = 8,
    attestation_fcn_id_oe_sgx_switchless_enclave_worker_thread_ecall = 9,
...
typedef struct _set_host_public_key_args_t
{
    oe_result_t oe_result;
    uint8_t* deepcopy_out_buffer;
    size_t deepcopy_out_buffer_size;
    int oe_retval;
    pem_key_t* host_public_key;
} set_host_public_key_args_t;

typedef struct _process_encrypted_defi_args_t
{
    oe_result_t oe_result;
    uint8_t* deepcopy_out_buffer;
    size_t deepcopy_out_buffer_size;
    int oe_retval;
    message_t* encrypted_defi_package;
    message_t* response;
} process_encrypted_defi_args_t;
...
oe_result_t attestation_set_host_public_key(
    oe_enclave_t* enclave,
    int* _retval,
    pem_key_t* host_public_key)
{
    ...
    /* Marshalling struct. */
    set_host_public_key_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    /* Marshalling buffer and sizes. */
    size_t _input_buffer_size = 0;
    size_t _output_buffer_size = 0;
    size_t _total_buffer_size = 0;
    ...
    /* Fill marshalling struct. */
    memset(&_args, 0, sizeof(_args));
    _args.host_public_key = (pem_key_t*)host_public_key;

    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(set_host_public_key_args_t));
    if (host_public_key)
        OE_ADD_ARG_SIZE(_input_buffer_size, 1, sizeof(pem_key_t));
    if (host_public_key && host_public_key->buffer)
        OE_ADD_ARG_SIZE(_input_buffer_size, 1, _args.host_public_key->size);
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(set_host_public_key_args_t));
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (set_host_public_key_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    if (host_public_key)
        OE_WRITE_IN_PARAM(host_public_key, 1, sizeof(pem_key_t), pem_key_t*);
    if (host_public_key && host_public_key->buffer)
        OE_WRITE_IN_PARAM(host_public_key->buffer, 1, _args.host_public_key->size, uint8_t*);
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _attestation_ecall_info_table[attestation_fcn_id_set_host_public_key].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (set_host_public_key_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
...
OE_WEAK_ALIAS(attestation_set_host_public_key, set_host_public_key);

oe_result_t attestation_process_encrypted_defi(
    oe_enclave_t* enclave,
    int* _retval,
    message_t* encrypted_defi_package,
    message_t* response)
{
    ...
    /* Marshalling struct. */
    process_encrypted_defi_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    /* Marshalling buffer and sizes. */
    size_t _input_buffer_size = 0;
    size_t _output_buffer_size = 0;
    size_t _total_buffer_size = 0;
    ...
    /* Fill marshalling struct. */
    memset(&_args, 0, sizeof(_args));
    _args.encrypted_defi_package = (message_t*)encrypted_defi_package;
    _args.response = (message_t*)response;

    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(process_encrypted_defi_args_t));
    if (encrypted_defi_package)
        OE_ADD_ARG_SIZE(_input_buffer_size, 1, sizeof(message_t));
    if (encrypted_defi_package && encrypted_defi_package->data)
        OE_ADD_ARG_SIZE(_input_buffer_size, 1, _args.encrypted_defi_package->size);
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(process_encrypted_defi_args_t));
    if (response)
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (process_encrypted_defi_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    if (encrypted_defi_package)
        OE_WRITE_IN_PARAM(encrypted_defi_package, 1, sizeof(message_t), message_t*);
    if (encrypted_defi_package && encrypted_defi_package->data)
        OE_WRITE_IN_PARAM(encrypted_defi_package->data, 1, _args.encrypted_defi_package->size, uint8_t*);
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _attestation_ecall_info_table[attestation_fcn_id_process_encrypted_defi].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (process_encrypted_defi_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    *_retval = _pargs_out->oe_retval;
    ...
    OE_READ_OUT_PARAM(response, 1, sizeof(message_t));
    if (response && response->data)
        OE_SET_DEEPCOPY_OUT_PARAM(response->data, 1, response->size, uint8_t*);
...
OE_WEAK_ALIAS(attestation_process_encrypted_defi, process_encrypted_defi);
...
enum
{
    ...
    attestation_fcn_id_oe_get_quote_verification_collateral_with_baseline_ocall = 77,
    attestation_fcn_id_oe_verify_quote_ocall = 78,
    attestation_fcn_id_oe_sgx_get_cpuid_table_ocall = 79,
    attestation_fcn_id_oe_sgx_backtrace_symbols_ocall = 80,
    attestation_fcn_id_oe_sgx_log_backtrace_ocall = 81,
    attestation_fcn_id_oe_sgx_thread_wake_wait_ocall = 82,
    attestation_fcn_id_oe_sgx_wake_switchless_worker_ocall = 83,
    attestation_fcn_id_oe_sgx_sleep_switchless_worker_ocall = 84,
    attestation_fcn_id_oe_get_tdx_quote_verification_collateral_ocall = 85,
    attestation_fcn_id_oe_verify_tdx_quote_ocall = 86,
